        ...
        <div className="myContainer">
          <div className="whychooseus">
              ...
              <div className="wcuheadingp">
                <p>The decision to become an exceptional is a highly personal one, based on a number of factors that you must <br/> weigh for yourself. It's not a step to be taken lightly. We are different because</p>
              </div>
